			...
			if($query) // will return true if succefull else it will return false
			 {
				...
				?>
                       <div class="col-lg-12">
						    <form  class="form-horizontal" action="api/edit_admin.php" method="post" enctype="multipart/form-data">
				...
				else	
				{
					echo $img;
                                        ...
                                        <div class="form-group"><label class="col-lg-2 control-label"> الاسم </label>
                                                <div class="col-lg-10"><input name="name" required="required" value="<?php echo $admin_name; ?>" type="text" placeholder="" class="form-control" >
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-10"><input type="password"  required="required" id="password" name="password1" placeholder="*****" class="form-control">
                            </div>
                        </div>
                        <div class="form-group"><label class="col-lg-2 control-label">  تأكيد كلمة المرور</label>
                        <div class="col-lg-10"><input type="password" required="required" id="confirm_password" placeholder="*****"  class="form-control">
                    </div>
                </div>
