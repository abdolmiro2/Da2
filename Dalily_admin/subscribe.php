                ...
                <div class="col-lg-12">
                  <div class="ibox ">
                    <div class="ibox-title">
                      ...
                      <h3 class="title m-t-sm pull-left">الاشتراكات</h3>
                      <br>
                      <br>
                      <br>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                          <thead>
                            <tr class="frist">
                              ...
                              <th class="text-center">بريد المشترك</th>
...
$sql= "SELECT * FROM  `participation` ORDER BY id DESC";
...
$(document).ready(function () {
     $('.demo4').click(function () {
		  var the_id=$(this).prop("id");
            swal({
                        title: "هل انت متاكد ؟",
                        text: "لن تكون قادرا على استرداد هذه البيانات  !",
                        type: "warning",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
							...
							$.ajax({
									type:'GET',
									url:'api/del_participation.php?id='+the_id,
                            ...
                            swal("احذف!", "تم الحذف بنجاح.", "success");
                        } else {
                            swal("الغى", "لم يتم الحذف   :)", "error");
                        }
                    });
        });
});
