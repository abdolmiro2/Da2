                  ...
                  <ul class="nav navbar-nav navbar-left">
                     ...
                     <li ><a class="page-scroll" href="contact.php?lang=ar">
                        <span><i class="fa fa-envelope-open-o" aria-hidden="true"></i></span> التواصل</a>
										 ...
										 <?php if($area != "" || $category != "" || $text != ""){ ?>
                     <li><a id="ar" class="lang" class="page-scroll" href="<?php echo "index.php?lang=en&area=" . $area ."&category=" . $category . "&text=" .$text; ?>" ><span><i class="fa fa-flag-o" aria-hidden="true"></i></span> English</a>
										 <?php }else { ?>
										 <li><a id="ar" class="lang" class="page-scroll" href="index.php?lang=en"><span><i class="fa fa-flag-o" aria-hidden="true"></i></span> English</a>
										 <?php } ?>
                     </li>
                  </ul>
               </div>
            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-left">
                     ...
                     <?php if($area != "" || $category != "" || $text != ""){ ?>
<li><a id="ar" class="lang" class="page-scroll" href="<?php echo "index.php?lang=ar&area=" . $area ."&category=" . $category . "&text=" .$text; ?>" ><span><i class="fa fa-flag-o" aria-hidden="true"></i></span> العربية</a>
                     <?php }else { ?>
                     <li><a id="ar" class="lang" class="page-scroll" href="index.php?lang=ar"><span><i class="fa fa-flag-o" aria-hidden="true"></i></span> العربية</a>
                     <?php } ?>
                  </ul>
               </div>
               <!-- /.navbar-collapse -->
