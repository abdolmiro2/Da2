      ...
      <footer id="footer" >
         <div class="container">
            <div class="row m-t-10 m-b-10 text-center">
               ...
               <div class="col-md-12 m-t-10 text-center ">
                  <ul class="list-inline m-t-10 text-center">
                     <li class="active list-inline-item"><a class="page-scroll" href="<?php echo "index.php?lang=".$lang; ?>"> Home</a></li>
                     <li class="list-inline-item"><a class="page-scroll" href="<?php echo "creat-card.php?lang=".$lang; ?>"> Create Your BC </a></li>
                     <li class="list-inline-item"><a class="page-scroll" href="<?php echo "contact.php?lang=".$lang; ?>">Contact </a></li>
                     <li class="list-inline-item"><a class="page-scroll" href="<?php echo "jobs.php?lang=".$lang; ?>">Jobs </a></li>
                     <li class="list-inline-item"><a class="page-scroll" href="<?php echo "terms.php?lang=".$lang; ?>">Terms & Conditions </a></li>
                     <li class="list-inline-item"><a class="page-scroll" href="<?php echo "privacy-policy.php?lang=".$lang; ?>">Privacy Policy</a></li>
