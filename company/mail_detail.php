...
if(isset($_GET["id"]))
{
	$id=$_GET["id"];
	 ...
	 $sql="SELECT id,name,email,msg AS msg,phone,time  FROM request_service WHERE id='$id'";
        ...
        <div class="row">
           <div class="col-lg-12 animated fadeInRight">
            <div class="mail-box-header">
                ...
                <h2>
                            <small  class="pull-right "> <a href="mailbox.php"> <small>&nbsp  الذهاب لصفحة الطلبات &nbsp</small> </a>  </small>  <br/>
					تواصل معنا
