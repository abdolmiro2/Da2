            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-left">
                     ...
                     <li><a id="ar" class="lang" class="page-scroll" href="creat-card.php?lang=en"><span><i class="fa fa-flag-o" aria-hidden="true"></i></span> English</a>
                     </li>
                  </ul>
               </div>
               <!-- /.navbar-collapse -->
            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-left">
                     ...
                     <li><a id="en" class="lang" class="page-scroll" href="creat-card.php?lang=ar"><span><i class="fa fa-flag-o" aria-hidden="true"></i></span> العربية</a>
                     </li>
                  </ul>
               </div>
               <!-- /.navbar-collapse -->
